...
class About_us extends Admin_Controller
{
    ...
    public function index()
    {
        // set active sidebar
        $this->data['page'] = "page";
        $this->data['sidebar'] = "static about us";
        ...
        $this->data['static_page'] = $this->admin_model->get_static_page_with_lang('about us', $lang);

        $this->twig->display('adminuao3hltbr0/static_page/static_page_about_us', $this->data);
        return;
    }

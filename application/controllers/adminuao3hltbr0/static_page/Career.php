...
class Career extends Admin_Controller
{
    ...
    public function index()
    {
        // set active sidebar
        $this->data['page'] = "page";
        $this->data['sidebar'] = "static career";
        ...
        $this->data['static_page'] = $this->admin_model->get_static_page_with_lang('career', $lang);

        $this->twig->display('adminuao3hltbr0/static_page/static_page_career', $this->data);
        return;
    }

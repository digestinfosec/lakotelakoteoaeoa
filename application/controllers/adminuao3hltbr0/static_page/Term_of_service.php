...
class Term_of_service extends Admin_Controller
{
    ...
    public function index()
    {
        // set active sidebar
        $this->data['page'] = "page";
        $this->data['sidebar'] = "static term of service";
        ...
        $this->data['static_page'] = $this->admin_model->get_static_page_with_lang('terms of service', $lang);

        $this->twig->display('adminuao3hltbr0/static_page/static_page_tos', $this->data);
        return;
    }

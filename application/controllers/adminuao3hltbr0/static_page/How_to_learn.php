...
class How_to_learn extends Admin_Controller
{
    ...
    public function index()
    {
        // set active sidebar
        $this->data['page'] = "page";
        $this->data['sidebar'] = "static how to learn";
        ...
        $this->data['static_page'] = $this->admin_model->get_static_page_with_lang('how to learn', $lang);

        $this->twig->display('adminuao3hltbr0/static_page/static_page_how_to_learn', $this->data);
        return;
    }

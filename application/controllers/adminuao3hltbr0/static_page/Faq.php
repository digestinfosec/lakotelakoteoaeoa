...
class Faq extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['static_page'] = $this->admin_model->get_static_page_with_lang('faq', $lang);

        $this->twig->display('adminuao3hltbr0/static_page/static_page_faq', $this->data);
        return;
    }

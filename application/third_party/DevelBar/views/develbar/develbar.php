            ...
            <div class="detail">
                ...
                <?php if ($ci_new_version !== false): ?>
                    <p>
                        ...
                        <?php echo sprintf(lang('update_message'),
                            anchor($config['ci_download_link'], $ci_new_version, 'target="_blank"')) ?>
                    </p>
                <?php endif ?>
                <p><?php echo anchor($config['documentation_link'], 'CodeIgniter documentation',
                        'target="_blank"') ?></p>
                ...
                <?php if ($develbar_new_version !== false): ?>
                    <p>
                        <span class="label warning"><?php echo lang('info') ?></span>
                        <?php echo sprintf(lang('update_message'),
                            anchor($config['develbar_download_link'], $develbar_new_version, 'target="_blank"')) ?>
                    </p>
                <?php endif ?>
